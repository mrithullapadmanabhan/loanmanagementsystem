...
public class ItemCardControllerTest {
    ...
    public void getTest() throws Exception {
        ...
        mvc.perform(get("/api/itemcard")
                ...
                .andExpect(jsonPath("$[0].make", Matchers.equalTo(itemCardList.get(0).getMake())))
                .andExpect(jsonPath("$[1].id", Matchers.equalTo(itemCardList.get(1).getId().toString())))
                .andExpect(
                        jsonPath("$[1].make", Matchers.equalTo(itemCardList.get(1).getMake())));
    }
    ...
    public void getByMakeTest() throws Exception {
        ...
        mvc.perform(get("/api/itemcard/make/{makeID}", makeID)
                ...
                .andExpect(jsonPath("$.make", Matchers.equalTo(itemCard.getMake())));
    }
